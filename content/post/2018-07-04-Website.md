...
cd ../../..
```
Similarly, update the files in the {{< hl-text orange >}}layouts{{< /hl-text >}} and the {{< hl-text orange >}}archetypes{{< /hl-text >}} folder with provided archetypes for posts and pages.<br>
```
