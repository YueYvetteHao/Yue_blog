...
brew install hugo
```
Once Hugo is installed, you can create a new directory:
```
...
```
Move everything from the {{< hl-text orange >}}Newsite{{< /hl-text >}} to the {{< hl-text orange >}}BLOG{{< /hl-text >}} directory
```
cd Newsite/
...
Get the deploy script [here](https://gohugo.io/hosting-and-deployment/hosting-on-github/) and save it in the {{< hl-text orange >}}BLOG{{< /hl-text >}} folder.
